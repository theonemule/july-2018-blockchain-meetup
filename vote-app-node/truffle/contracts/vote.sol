...
contract vote {
	...
	function hasVoted(address entityAddress) public constant returns(bool voteRecordExists) {
		return voted[entityAddress];
	}
	
	function voteCount(uint candidate) public constant returns(uint votes) {
